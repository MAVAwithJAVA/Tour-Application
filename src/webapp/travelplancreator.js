...
function getDestinations() {
    ...
    xhttp.open("GET", "http://localhost:8081/TourWeb_war_exploded/api/travelPlanController/getDestinations", true);
    xhttp.send();
}
...
function saveTravelPlan() {
    ...
    if (travelPlanData.selectedDestinationList.length !== 0 && travelPlanData.selectedRating !== "" &&
        ...
        let xhttp = new XMLHttpRequest();
        xhttp.open("POST", "http://localhost:8081/TourWeb_war_exploded/api/travelPlanController/addDestinations", true);
        xhttp.onreadystatechange = function() {
