...
function startJPA() {
    ...
    xhttp.open("GET", "http://localhost:8081/TourWeb_war_exploded/api/jpaController/startJPA", true);
...
function logIn() {
    ...
    if (username !== "" && password !== "") {
        ...
        let xhttp = new XMLHttpRequest();
        xhttp.open("POST", "http://localhost:8081/TourWeb_war_exploded/api/travelPackageController/verifyAccount", true);
        xhttp.onreadystatechange = function() {
...
function viewTravelPackages() {
    ...
    let xhttp = new XMLHttpRequest();
    xhttp.open("POST", "http://localhost:8081/TourWeb_war_exploded/api/travelPackageController/getTravelPackages", true);
    xhttp.onreadystatechange = function () {
        if (xhttp.readyState > 3 && xhttp.status == 200) {
...
function removeTravelPackage(id) {
    if (confirm("Are you sure you want to delete this travel package?")) {
        ...
        let xhttp = new XMLHttpRequest();
        xhttp.open("DELETE", "http://localhost:8081/TourWeb_war_exploded/api/travelPackageController/deleteTravelPackage", true);
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState > 3 && xhttp.status == 200) {
...
function updateTravelPackage() {
    if (validateForm()) {
        ...
        let xhttp = new XMLHttpRequest();
        xhttp.open("PUT", "http://localhost:8081/TourWeb_war_exploded/api/controller/putTraveler", true);
        xhttp.onreadystatechange = function() {
            if (xhttp.readyState > 3 && xhttp.status == 200) {
